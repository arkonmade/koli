  ...
  return (
    <div className="profile-inner">
      ...
      <div className="profile-cover">
        {coverImg ? (
          ...
          <div
            style={{
              ...
              height: "100%",
              overflow: "hidden",
              background: `linear-gradient(135deg, ${inf.color}44 0%, ${inf.color}99 50%, var(--s2) 100%)`,
            }}
          >
            <img
              className="w-full opacity-[.2] h-full object-cover"
              loading="lazy"
              src={
                inf.avatar ||
        ...
        <Link href="/browse" className="back-btn">
          <BackIcon /> Back
        </Link>
      </div>
      ...
      <div
        className="prof-body"
        style={{ padding: "0 20px 32px", marginTop: -48, position: "relative" }}
      >
        {/* Avatar + CTA */}
        ...
        <div className="prof-tags">
          ...
          {inf.is_featured && (
            <span
              ...
              style={{
                color: "var(--lime)",
                borderColor: "rgba(182,255,46,0.3)",
              }}
            >
              ⭐ Featured
            </span>
            ...
            {inf.socials!.map((s) => {
              ...
              return (
                <a
                  key={s.id}
                  className="soc-row"
                  href={buildUrl(s.platform, s.handle)}
                  target="_blank"
                  rel="noreferrer"
                >
                  <div
        ...
        {user ? (
          <div className="det-grid">
            <div className="det-card">
              ...
              <div className="det-val" style={{ color: "var(--lime)" }}>
                {fmtFollowers(reach)}
              </div>
              <div style={{ fontSize: 11, color: "var(--gray)", marginTop: 4 }}>
                across {(inf.socials ?? []).length} platforms
              </div>
            </div>
            <div className="det-card">
          ...
          <div className="gated-box">
            ...
            >
              Phone number, rate, total reach, and analytics are only visible to
              signed-in users.
            </p>
